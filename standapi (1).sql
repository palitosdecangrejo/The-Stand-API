...
(69, NULL, 'Cream Starter', 'Stand que permite generar y moldear carne humana en forma de spray para curar heridas o atacar.', 'Parte 7', 'https://static.jojowiki.com/images/7/7b/latest/20240204003114/Cream_Starter_Infobox_Manga.png', NULL, 'B', 'C', 'A', 'B', 'B', 'C', 'Sunshine of Your Love Cream'),
...
(74, NULL, 'Eclipse Eight', 'Stand que manipula fenómenos y energía de forma compleja y destructiva.', 'Parte 9', 'https://static.jojowiki.com/images/f/fd/latest/20260122182848/Eclipse_Eight_Infobox_Manga.png', NULL, 'B', 'B', 'B', 'B', 'B', 'B', NULL);
-- --------------------------------------------------------
