...
(17, 'Jolyne Cujoh', 'Protagonista de la Parte 6; hija de Jotaro, acaba en prisión y lucha contra el plan de Pucci.', 'Parte 6', NULL, NULL),
(18, 'Ermes Costello', 'Aliada de Jolyne en prisión; busca venganza.', 'Parte 6', NULL, NULL),
(19, 'Weather Report', 'Aliado con pasado trágico y poderes climáticos; se desconoce su nombre por lo que se le llama como a su Stand.', 'Parte 6', NULL, NULL),
(20, 'Enrico Pucci', 'Sacerdote y seguidor de DIO; busca crear un "paraíso" controlando el universo.', 'Parte 6', NULL, NULL),
...
(23, 'Hol Horse', 'Pistolero mercenario de DIO; combate utilizando balas manipulables.', 'Parte 3', NULL, NULL),
(24, 'Vanilla Ice', 'Sirviente fanático de DIO con un Stand basado en el vacío absoluto.', 'Parte 3', NULL, NULL),
(25, 'Yoshikage Kira', 'Asesino en serie obsesionado con la tranquilidad; vive oculto en Morioh.', 'Parte 4', NULL, NULL),
(26, 'Keicho Nijimura', 'Hermano de Okuyasu; controla un ejército miniatura mediante su Stand.', 'Parte 4', NULL, NULL),
...
(29, 'Trish Una', 'Hija de Diavolo; capaz de volver blandos los objetos.', 'Parte 5', NULL, NULL),
...
(32, 'Foo Fighters', 'Entidad de plancton inteligente que adopta forma humana; aliada de Jolyne.', 'Parte 6', NULL, NULL),
(33, 'Narciso Anasui', 'Prisionero obsesionado con Jolyne; experto en infiltración estructural.', 'Parte 6', NULL, NULL),
(34, 'Johnny Joestar', 'Protagonista de la Parte 7; exjinete paralítico que compite en la carrera para recuperar su vida.', 'Parte 7', NULL, NULL),
(35, 'Gyro Zeppeli', 'Compañero de Johnny; maestro del "Spin"; figura clave y participante de la Steel Ball Run.', 'Parte 7', NULL, NULL),
...
(38, 'Doctor Ferdinand', 'Paleontólogo obsesionado con los dinosaurios; usuario secundario de Scary Monsters.', 'Parte 7', NULL, NULL),
(39, 'Funny Valentine', 'Presidente de EE.UU.; quiere reunir el "cadáver sagrado" para beneficiar a su país.', 'Parte 7', NULL, NULL),
(40, 'Diego Brando', 'Versión alternativa de Diego que posee The World.', 'Parte 7', NULL, NULL),
(41, 'Josuke Higashikata', 'Protagonista de la Parte 8; versión alternativa de Josuke; joven amnésico encontrado en Morioh, ligado a un misterio de identidad.', 'Parte 8', NULL, NULL),
(42, 'Tooru', 'Misterioso enemigo ligado a los Rock Humans; manipula la desgracia.', 'Parte 8', NULL, NULL),
(43, 'Yoshikage Kira', 'Versión alternativa del universo JoJolion vinculada a Killer Queen.', 'Parte 8', NULL, NULL),
(44, 'Jodio Joestar', 'Protagonista de la Parte 9; adolescente ambicioso en Hawái que busca enriquecerse junto a su banda.', 'Parte 9', NULL, NULL),
(45, 'Rohan Kishibe', 'Versión alternativa de Rohan; presente en la Parte 9: The JOJOLands.', 'Parte 9', NULL, NULL),
